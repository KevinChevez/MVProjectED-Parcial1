...
public class VistaVideo {
    ...
    private Iterator<Video> mostrarVideos(Iterator<Video> ite){
        Video video = ite.next();
        MediaView mediaViewer = video.mostrarVideo();
        MediaPlayer player = mediaViewer.getMediaPlayer();
        player.setOnEndOfMedia(()->{
            mostrarVideos(ite);
        });
        video.mostrarVideo();
        vAtencion.getSeccionVideo().getChildren().clear();
        vAtencion.getSeccionVideo().getChildren().add(mediaViewer);
        return mostrarVideos(ite);
    }
...
//        MediaPlayer player = mediaViewer.getMediaPlayer();
//        player.setOnEndOfMedia(()->{
//            Video video2 = it.next();
//            MediaView mediaView = video2.mostrarVideo();
//            vAtencion.getSeccionVideo().getChildren().clear();
